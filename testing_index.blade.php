 ...
 *  
 *  Γ£à Bug #4: allTransactions tidak accessible dari outer scope
 *
 *  INSTRUKSI:
                ...
                @if(auth()->user()->role !== 'teknisi')
                    ...
                    <div class="flex items-center gap-2">
                        <div class="flex items-center gap-1.5 bg-gray-50 border border-gray-200 rounded-xl px-2.5 py-2 focus-within:ring-2 focus-within:ring-blue-100 focus-within:border-blue-300 transition-all">
                            ...
                            <span class="text-gray-300 text-[10px]">ΓÇö</span>
        ...
        <div class="bg-white rounded-none sm:rounded-2xl shadow-2xl max-w-2xl w-full h-[100dvh] sm:h-auto sm:max-h-[90vh] flex flex-col overflow-hidden transform scale-95 transition-all duration-300 overscroll-contain"
            ...
            <div id="view-body" class="flex-col flex-auto min-h-0 w-full" style="display: none;">
                ...
                <div class="p-6 space-y-6 overflow-y-auto grow min-h-0 overscroll-contain">
                    ...
                    {{-- Γ£à Revisi Banner (Pengajuan yang direvisi Management) --}}
                    <div id="v-revision-banner" class="hidden"></div>

                    {{-- Γ£à UPDATED: Foto dengan Click-to-Zoom --}}
                    ...
                    {{-- Γ£à Summary Area (Keterangan Global & Total Estimasi) --}}
                    ...
                    <div id="v-waiting-owner" class="hidden bg-amber-50 border border-amber-200 rounded-xl p-4">
                        <div class="flex items-center gap-2 text-amber-700">
                            ...
                            <p class="text-xs font-bold">Menunggu persetujuan dari Owner (nominal ΓëÑ Rp 1.000.000)</p>
                        </div>
                    </div>
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                                        <div class="space-y-1.5">
                                            ...
                                            <p class="text-xs text-slate-400 font-medium">
                                                ...
                                                <span class="mx-1 opacity-50">ΓÇó</span> 
...
@push('modals')
    {{-- Γ£à IMAGE VIEWER MODAL (Fullscreen Zoom) --}}
    <div id="image-viewer"
...
@section('styles')
    <style>
        ...
        /* ΓöÇΓöÇ Branch Tag Truncation Tooltip ΓöÇΓöÇ */
        .branch-more-wrap {
            position: relative;
            display: inline-flex;
        }
...
<script>
    ...
    // Klik backdrop (di luar viewer-card) ΓåÆ tutup
    if (imageViewer) {
    ...
    const SearchEngine = (function() {
        ...
        // Γ£à CHANGE: Make loadData return Promise
        ...
        function renderPagination() {
            ...
            // Page numbers ΓÇö fewer visible on mobile
            ...
            if (startPage > 1) {
                ...
                if (startPage > 2) {
                    html += `<span class="text-xs text-gray-400 px-0.5">ΓÇª</span>`;
                }
            }
        ...
        // ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
        // Branch Tags Truncation ΓÇö max 2 visible, rest in tooltip
        // ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
        ...
        // Γ£à Edit button builder ΓÇö enforces spec rules:
        //   - Pengajuan + status completed ΓåÆ sembunyikan
        //   - Admin ΓåÆ tampilkan dengan label "Lihat Versi" (read-only di server)
        // ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        function generateMobileCard(t, rowNum = '') {
            ...
            // CRUD buttons ΓÇö compact, same height as contextual actions
            const crudButtons = `
        ...
        function generateAIBadge(t) {
            ...
            const completedLabel = isHighConfidence ? 'AI Γ£ô High' : (t.confidence ? 'AI Γ£ô Low' : 'AI Γ£ô');
            ...
            const aiBadge = {
                ...
                completed:  { color: completedColor, icon: 'check-circle', label: completedLabel, pulse: false, title: `Selesai ΓÇó Confidence: ${t.confidence ?? 0}%` },
                error:      { color: 'bg-red-50 text-red-600 border-red-200', icon: 'alert-circle', label: 'AI Γ£ù', pulse: false, title: 'Gagal ΓÇó Silakan isi manual' },
            }[t.ai_status];
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Γ£à Initialize aria-hidden=true for all modals (important for accessibility)
        ...
        if (typeof window.Echo !== 'undefined') {
            ...
            echoChannel.listen('.transaction.updated', (e) => {
                console.log('≡ƒöö [REALTIME] Transaction Updated:', e);
            ...
            console.log('≡ƒôí [REALTIME] Echo listener initialized on channel: ' + 
    ...
    function openViewModal(id) {        currentTransactionId = id;
        ...
        fetch(`/transactions/${id}/detail-json`)
            ...
            .then(d => {
                ...
                // Γ£à ATTACH CLICK EVENT TO IMAGE
    ...
    function renderViewModal(d) {
        ...
        document.getElementById('v-invoice').textContent = d.invoice_number + ' ΓÇó ' + d.created_at;
        ...
        // Γ£à Revisi Banner untuk Pengajuan yang sudah diedit Management
    ...
    // ΓöÇΓöÇΓöÇ Version Toggle in Detail Modal ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    function toggleVersionInModal(version) {
        ...
        // Γ£à Riwayat Pembayaran (Payment History)
            ...
            if (hist.payment_method && methodWrap) {
                ...
                if (hist.payment_method === 'transfer_teknisi') {
                    ...
                    if (hist.submitter) {
                        ...
                        accountInfo = `${bank} ΓÇó ${name}<br>${number}`;
                    }
    ...
    // ΓöÇΓöÇΓöÇ Central AJAX status update (no page reload) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    // ΓöÇΓöÇΓöÇ OVERRIDE MODAL ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    // ΓöÇΓöÇΓöÇ FORCE APPROVE MODAL ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    // ΓöÇΓöÇΓöÇ PAYMENT MODAL ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    // ΓöÇΓöÇΓöÇ INIT AJAX FORMS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    // ΓöÇΓöÇΓöÇ TECHNICIAN CASH CONFIRMATION ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    function debouncedRefresh(eventName, data) {
        console.log(`≡ƒöö [REVERB] Event received: ${eventName}`, data);
        
        clearTimeout(refreshTimer);
        refreshTimer = setTimeout(() => {
            console.log(`≡ƒöä [REVERB] Refreshing grid after ${eventName}...`);
            SearchEngine.init().then(() => {
                console.log(`Γ£à [REVERB] Grid refreshed successfully`);
                ...
                console.error(`Γ¥î [REVERB] Grid refresh failed:`, err);
            });
        }, REFRESH_DEBOUNCE_MS);
    }

    // Γ£à Handler untuk TransactionUpdated event
    window.handleRealtimeTransactionUpdate = function(transaction) {
        console.log('≡ƒô¥ [REVERB] Transaction Updated:', transaction);
    ...
    // Γ£à Handler untuk TransactionCreated event
    window.handleRealtimeTransactionCreation = function(transaction) {
        console.log('≡ƒåò [REVERB] Transaction Created:', transaction);
        if (transaction && transaction.id) {
    ...
    // Γ£à Handler khusus untuk OCR status updates
    window.handleRealtimeOcrStatusUpdate = function(data) {
        console.log('≡ƒñû [REVERB] OCR Status Updated:', data);
