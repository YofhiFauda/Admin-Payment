    ...
    <div>
        ...
        <div class="max-w-lg mx-auto py-3 md:py-4 lg:py-6 px-3 md:px-0">
            <form action="{{ route('transactions.upload') }}" method="POST" enctype="multipart/form-data" id="upload-form">
                @csrf
                <div class="bg-white rounded-xl md:rounded-2xl lg:rounded-3xl border-2 border-dashed border-gray-200 p-6 md:p-8 lg:p-12 text-center hover:border-blue-400 hover:bg-blue-50/20 transition-all group cursor-pointer relative shadow-sm"
                    ...
                    <div id="upload-default">
                        <div
                            class="bg-gradient-to-br from-blue-500 to-indigo-600 w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-lg md:rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto mb-3 md:mb-4 lg:mb-5 group-hover:scale-105 transition-transform shadow-lg shadow-blue-500/30">
                            <i data-lucide="upload" class="w-5 h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 text-white"></i>
                        </div>
                        <h3 class="text-base md:text-lg lg:text-xl font-bold mb-1.5 md:mb-2 text-slate-800">Unggah Nota</h3>
                        <p
                            class="text-slate-400 mb-4 md:mb-5 lg:mb-6 text-xs md:text-sm font-medium leading-relaxed max-w-xs mx-auto">
                            Letakkan
                            file nota digital Anda di sini</p>
                        <label
                            class="bg-slate-900 hover:bg-blue-600 text-white px-5 md:px-6 lg:px-8 py-2.5 md:py-3 rounded-lg md:rounded-xl font-bold cursor-pointer transition-all shadow-lg inline-block text-xs md:text-sm active:scale-95">
                            Pilih Berkas Nota
