...
@section('content')
    ...
    <div class="h-dvh sm:h-screen overflow-y-auto flex flex-col justify-center
...
@endsection
    ...
    <div id="choiceModal"
        ...
        bg-black/40 backdrop-blur-md z-50 opacity-0 transition-opacity duration-300">

        <div id="modalBox"
            class="bg-white/80 backdrop-blur-xl rounded-3xl w-full max-w-md p-8
            transform scale-95 opacity-0 mx-4 sm:mx-auto
