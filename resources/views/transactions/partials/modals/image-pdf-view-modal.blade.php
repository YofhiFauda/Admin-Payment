        ...
        <div class="flex justify-between items-center shrink-0 mb-6 border-b border-slate-100 pb-4">
            <div>
                <h3 class="text-sm sm:text-base font-black text-slate-800 uppercase tracking-widest"
                    id="viewer-header-title">PREVIEW DOKUMEN</h3>
                <p id="viewer-title" class="text-[10px] text-slate-400 font-bold mt-1 uppercase tracking-wider">Klik
                    di luar gambar atau X untuk menutup</p>
            </div>
            <button id="close-viewer" type="button" onclick="closeImageViewer()"
