        ...
        <div id="payment-body" class="p-6 hidden">
            ...
            <form id="payment-form" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="file" name="file" id="payment_file_input" accept=".jpg,.jpeg,.png,.pdf"
                ...
                <div class="flex gap-3">
                    ...
                    <button type="submit" id="btnSubmitPayment"
                        ...
                        <svg class="w-4 h-4 animate-spin absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 hidden" id="btnSubmitPaymentLoader" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
