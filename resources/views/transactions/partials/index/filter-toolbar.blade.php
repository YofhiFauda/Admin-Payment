...
<div class="show-on-laptop flex flex-wrap min-[1510px]:flex-nowrap items-center gap-3 md:gap-4 lg:gap-3">
    {{-- <div class="hidden lg:flex flex-wrap min-[1440px]:flex-nowrap items-center gap-3 md:gap-4 lg:gap-3"> --}}
        ...
        <div class="flex items-center gap-3 w-full min-[1510px]:w-auto">
            <div class="flex-1 min-[1510px]:flex-none grid grid-cols-4 gap-2 min-[1510px]:flex min-[1510px]:items-center min-[1510px]:gap-2 overflow-x-auto scrollbar-hide pb-1 min-[1510px]:pb-0">
                @php 
            ...
            @if(auth()->user()->role !== 'teknisi')
                ...
                <button type="button" id="btn-open-export" onclick="openExportModal()"
                    class="flex items-center gap-2 px-3.5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold transition-all shadow-sm shadow-emerald-600/20 active:scale-95 whitespace-nowrap">
                    <i data-lucide="download" class="w-3.5 h-3.5"></i>
                    <span class="hidden min-[1510px]:inline">Export Excel</span>
                    <span class="min-[1510px]:hidden">Export</span>
                </button>
            @endif
        </div>
</div>
        ...
        @if(auth()->user()->role !== 'teknisi')
            ...
            <div class="flex gap-3 mt-2">
                ...
                <button type="button" onclick="openExportModal()"
                    class="flex items-center justify-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-2xl text-xs font-bold transition-all shadow-sm shadow-emerald-600/20 active:scale-95 shrink-0">
    ...
    <div class="flex md:hidden flex-col gap-3">
        ...
        @if(auth()->user()->role !== 'teknisi')
            ...
            <!-- Row 4.5: Export Excel -->
            <button type="button" onclick="openExportModal()"
                class="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-2xl text-xs font-bold transition-all shadow-sm shadow-emerald-600/20 active:scale-95 animate-in fade-in duration-200">
                <i data-lucide="download" class="w-4 h-4"></i>
