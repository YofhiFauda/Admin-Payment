...
<div class="mb-8 md:mb-10 flex items-center gap-4">
    ...
    <div>
        <h1 class="text-2xl md:text-3xl font-bold text-slate-800 tracking-tight">Input Pembelian</h1>
        <p class="text-xs md:text-sm text-slate-400 mt-1">Catat belanja inventaris atau operasional pembelian secara manual</p>
    </div>
</div>
