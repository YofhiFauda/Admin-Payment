    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div class="p-6 border-b border-slate-100">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h3 class="text-xl font-black text-slate-900 leading-tight">Edit Akun Pengguna</h3>
                    <p class="text-xs text-slate-500 font-bold uppercase tracking-wider mt-0.5">Perbarui informasi profil <strong>{{ $user->name }}</strong></p>
                </div>
            </div>
        </div>
