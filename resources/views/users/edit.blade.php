            ...
            <div id="bankInfoSection" class="space-y-4 pt-4 border-t border-slate-100 hidden">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="flex gap-2">
                            <select id="rekening_bank" name="rekening_bank"
                                ...
                                @foreach($banks as $bank)
                                    <option value="{{ $bank->name }}" {{ old('rekening_bank', $user->rekening_bank) == $bank->name ? 'selected' : '' }}>{{ $bank->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" id="rekening_nomor" name="rekening_nomor" value="{{ old('rekening_nomor', $user->rekening_nomor) }}"
                    ...
                    <div class="space-y-1.5 sm:col-span-2">
                        ...
                        <input type="text" id="rekening_nama" name="rekening_nama" value="{{ old('rekening_nama', $user->rekening_nama) }}"
