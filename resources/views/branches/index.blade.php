...
<div class="p-4 md:p-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        ...
        <button onclick="openAddModal()"
            class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-linear-to-r from-sky-600 to-sky-600 text-white text-sm font-bold shadow-lg hover:opacity-90 transition-all">
                    ...
                    <tr class="branch-row" id="branch-row-{{ $branch->id }}">
                        ...
                        <td class="px-3 py-3">
                            <div class="flex items-center gap-2.5">
                                <div class="w-8 h-8 rounded-lg bg-linear-to-r from-sky-600 to-sky-600 flex items-center justify-center text-white font-bold text-[11px] flex-shrink-0">
